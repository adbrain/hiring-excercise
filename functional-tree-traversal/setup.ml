...
(* OASIS_START *)
(* DO NOT EDIT (digest: ed8f632df341c29597a34b892d062dd4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "http api for binary tree";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("conduit", None);
                           FindlibPackage ("conduit.lwt", None);
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("cohttp", None);
                           FindlibPackage ("cohttp.lwt", None);
                           FindlibPackage ("cohttp.lwt", None);
                           FindlibPackage ("ezjsonm", None);
                           FindlibPackage ("ezjsonm.lwt", None);
                           InternalLibrary "ttrav"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "ttrav.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "`Æ´á\153M }J­\bH\029\023_m";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
